  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-gray-950 flex flex-col lg:flex-row relative overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-8 overflow-y-auto relative z-10">
        <Card className="w-full max-w-md bg-gradient-to-br from-gray-800/60 to-slate-900/60 backdrop-blur-xl border border-purple-400/30 text-white shadow-xl shadow-purple-500/10 rounded-2xl">
          <CardHeader className="pb-4">
            <Link href={`/${locale}`} className="inline-flex max-w-[130px] items-center text-purple-300 hover:text-white mb-4 transition-colors">
        ...
        <div className="max-w-lg space-y-8 z-10 text-center lg:text-left">
          ...
          <div className="grid grid-cols-1 items-center sm:grid-cols-3 gap-6 pt-8 border-t border-purple-400/30 mt-8">
            <div className="text-center">
              <p className="text-purple-300 text-sm mb-1 font-medium tracking-wide">{t("volume")}</p>
              <p className="text-3xl font-black text-purple-400 drop-shadow-lg">$8.5B+</p>
            </div>
            <div className="text-center">
              <p className="text-purple-300 text-sm mb-1 font-medium tracking-wide">{t("traders")}</p>
              <p className="text-3xl font-black text-purple-400 drop-shadow-lg">1M+</p>
            </div>
            <div className="text-center">
              <p className="text-purple-300 text-sm mb-1 font-medium tracking-wide">{t("countries")}</p>
              <p className="text-3xl font-black text-purple-400 drop-shadow-lg">200+</p>
            </div>
          </div>
        </div>
      </div>
