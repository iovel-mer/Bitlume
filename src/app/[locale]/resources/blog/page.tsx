...
export default function BlogPage() {
  ...
  return (
    ...
    <div className="min-h-screen pt-20 bg-gradient-to-br from-gray-900 via-slate-900 to-gray-950 relative">
      ...
      <div className="absolute top-20 right-20 w-64 h-64 bg-gradient-to-br from-purple-500/15 to-indigo-500/15 rounded-full blur-3xl animate-pulse"></div>
      ...
      <main className="container mx-auto px-4 py-8 md:py-12 lg:py-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-white via-purple-200 to-indigo-200 md:text-5xl lg:text-6xl mb-6 tracking-wide drop-shadow-lg">
              {t("title")}
            </h1>
            ...
            <div className="flex items-center justify-center gap-6 mt-8 text-sm">
              <div className="flex items-center gap-2 px-4 py-2 bg-gray-900/50 text-purple-200 rounded-full border border-purple-400/30">
          ...
          <div className="lg:col-span-3">
            <article className="prose prose-lg prose-gray max-w-none">
              ...
              <section id="overview" className="mb-12">
                <Card className="bg-gray-900/60 backdrop-blur-xl border border-purple-400/20 shadow-xl hover:shadow-purple-500/20 transition-all duration-300 hover:border-purple-400/40 rounded-3xl overflow-hidden">
                  <CardContent className="p-8 text-white">
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <h2 className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-400 m-0 tracking-wide">
                        {t("overview.title")}
                      </h2>
                    </div>
