  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-gray-950 text-white px-6 py-20 relative flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-5xl w-full bg-gray-900/60 backdrop-blur-xl border border-purple-400/30 rounded-3xl shadow-xl shadow-purple-500/10 p-8 sm:p-12">
          {/* Navigation link */}
          <div className="mb-8">
              <Link
                  href="/"
