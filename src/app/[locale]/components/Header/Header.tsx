...
export const Header: React.FC = () => {
  ...
  return (
    <header className="container mx-auto bg-slate-950/95 backdrop-blur-2xl sticky top-0 z-50 border-b border-cyan-400/30">
      ...
      <div className="relative container mx-auto px-6 py-5">
          ...
          <div className="hidden md:flex items-center space-x-3">
            <Link href={`/${locale}/login`}>
              <Button className="group relative overflow-hidden flex items-center gap-2 px-6 py-3 rounded-full text-sm font-semibold 
                bg-slate-900/60 backdrop-blur-sm text-white border border-cyan-400/40 shadow-lg
                hover:bg-slate-800/60 hover:border-cyan-400/60 hover:shadow-xl hover:scale-105
                transition-all duration-300 ease-out cursor-pointer">
                
              
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-600/25 to-purple-600/25 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-full"></div>
            ...
            <div className="ml-4 pl-4 border-l border-cyan-400/40">
              <LanguageSwitcher />
            </div>
          </div>
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="md:hidden mt-6 space-y-4 p-6 bg-slate-950/85 backdrop-blur-xl rounded-2xl border border-cyan-400/30 shadow-2xl">
            <Link href={`/${locale}/login`} onClick={() => setIsMenuOpen(false)} className="block">
              <Button className="group relative overflow-hidden flex items-center gap-2 px-5 py-3 rounded-full text-sm font-semibold w-full
                bg-gradient-to-r from-cyan-600 to-purple-600 text-white border-0 shadow-lg shadow-cyan-500/30
            ...
            <Link href={`/${locale}/register`} onClick={() => setIsMenuOpen(false)} className="block">
              <Button className="group relative overflow-hidden flex items-center gap-2 px-5 py-3 rounded-full text-sm font-semibold w-full
                bg-slate-900/60 backdrop-blur-sm text-white border border-cyan-400/40 shadow-lg
                hover:bg-slate-800/60 hover:border-cyan-400/60 hover:shadow-xl hover:scale-[1.02]
                transition-all duration-300 ease-out cursor-pointer">
