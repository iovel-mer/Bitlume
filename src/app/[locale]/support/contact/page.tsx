...
export default function ContactPage() {
  ...
  return (
    <>
      <Header />
      <div className="min-h-screen container mx-auto py-8 sm:py-12 md:py-16 px-3 sm:px-4 md:px-6 lg:px-8 bg-gradient-to-br from-gray-900 via-slate-900 to-gray-950 relative overflow-hidden">
        {/* Background Grid */}
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black mb-4 sm:mb-6 bg-gradient-to-r from-white via-purple-200 to-indigo-200 bg-clip-text text-transparent leading-tight tracking-wide drop-shadow-lg px-2">
              {t("title")}
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-2xl mx-auto px-4">{t("subtitle")}</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 mb-12 sm:mb-16 md:mb-20">
            ...
            <div className="space-y-6 sm:space-y-8">
              {contactOptions.map((item, index) => (
                <Card key={index} className="group relative bg-gray-900/60 backdrop-blur-xl border border-purple-400/20 hover:border-purple-400/40 transition-all duration-500 hover:scale-105 cursor-pointer overflow-hidden rounded-2xl sm:rounded-3xl shadow-xl shadow-purple-500/10">
                  {/* Glow Effect */}
                  ...
                  <CardHeader className="relative z-10 p-4 sm:p-6">
                    <CardTitle className="flex items-center gap-3 sm:gap-4 text-lg sm:text-xl md:text-2xl font-black text-white group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-gray-200 group-hover:bg-clip-text transition-all duration-300 tracking-wide">
                      <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br ${item.gradient} flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                        <item.icon className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
                      </div>
                      {item.title}
                    </CardTitle>
                    <CardDescription className="text-gray-400 group-hover:text-gray-200 transition-colors duration-300 text-base sm:text-lg">
                      {item.description}
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="relative z-10 space-y-3 text-sm sm:text-base p-4 sm:p-6">
                    <p className="text-gray-500 group-hover:text-gray-300 transition-colors duration-300 flex items-center gap-3">
                      <Clock className="h-4 w-4 sm:h-5 sm:w-5 text-purple-400" /> {item.hours}
                    </p>
                  </CardContent>
            ...
            {/* Contact Form */}
            <Card className="h-fit shadow-xl border border-purple-400/20 bg-gray-900/60 backdrop-blur-xl rounded-2xl sm:rounded-3xl overflow-hidden">
              {/* Form Glow Effect */}
              ...
              <CardHeader className="relative z-10 pb-4 sm:pb-6 p-4 sm:p-6">
                <CardTitle className="text-2xl sm:text-3xl text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-400 font-black tracking-wide">
                  {t("form.title")}
                </CardTitle>
              ...
              <CardContent className="relative z-10 p-4 sm:p-6">
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                  <div className="grid gap-2 sm:gap-3">
                    ...
                    <Input
                      className="text-white bg-gray-800/50 border border-purple-400/30 focus:border-purple-400/60 rounded-xl h-10 sm:h-12 text-sm sm:text-base backdrop-blur-sm"
                      id="name"
                      name="name"
                  ...
                  <div className="grid gap-2 sm:gap-3">
                    ...
                    >
                      <SelectTrigger className="text-white bg-gray-800/50 border border-purple-400/30 focus:border-purple-400/60 rounded-xl h-10 sm:h-12 text-sm sm:text-base backdrop-blur-sm" id="subject">
                  ...
                  <div className="grid gap-2 sm:gap-3">
                    ...
                    <Textarea
                      ...
                      className="min-h-[120px] sm:min-h-[140px] text-white bg-gray-800/50 border border-purple-400/30 focus:border-purple-400/60 rounded-xl text-sm sm:text-base backdrop-blur-sm resize-none"
                  ...
                  <Button
                    ...
                    className={`w-full text-base sm:text-lg font-bold text-white transition-all duration-300 rounded-xl h-12 sm:h-14 tracking-wide ${
                      isFormValid() 
                        ? 'bg-black hover:bg-gray-800 cursor-pointer shadow-lg hover:shadow-xl' 
